...
public:
    ...
    static clsDate DecreaseDateByOneDay(clsDate Date)
    {
        if (Date.GetDay() == 1)
        {
            if (Date.GetMonth() == 1)
            {
                Date.SetMonth(12);                // Set the month to December
                Date.SetDay(31);                  // Set the day to 31
                Date.SetYear(Date.GetYear() - 1); // Decrement the year
            }
            else
            {
                Date.SetMonth(Date.GetMonth() - 1);                                 // Decrement the month
                Date.SetDay(NumberOfDaysInAMonth(Date.GetMonth(), Date.GetYear())); // Set day to last day of the new month
            }
        }
        else
        {
            Date.SetDay(Date.GetDay() - 1); // Decrement the day
        }
    ...
    static clsDate DecreaseDateByOneMonth(clsDate &Date)
    {
        ...
        // Ensure the day does not exceed the maximum days in the new month
        short NumberOfDaysInCurrentMonth = NumberOfDaysInAMonth(Date.GetMonth(), Date.GetYear());
        if (Date.GetDay() > NumberOfDaysInCurrentMonth)
        {
            Date.SetDay(NumberOfDaysInCurrentMonth); // Adjust the day to the last valid day in the new month
        }
    ...
    {
        Date.SetYear(Date.GetYear() - 1); // Correctly decrement the year using the setter
        return Date;
    }

    void DecreaseDateByOneYear()
    {
        DecreaseDateByOneYear(*this); // Use the static method for this object
    }

    static clsDate DecreaseDateByXYears(short Years, clsDate &Date)
    {
        Date.SetYear(Date.GetYear() - Years); // Correctly decrement the year using the setter
        return Date;
    }

    void DecreaseDateByXYears(short Years)
    {
        DecreaseDateByXYears(Years, *this); // Use the static method for this object
    }

    static clsDate DecreaseDateByOneDecade(clsDate &Date)
    {
        Date.SetYear(Date.GetYear() - 10); // Correctly decrement the year by 10 using the setter
        return Date;
    }

    void DecreaseDateByOneDecade()
    {
        DecreaseDateByOneDecade(*this); // Use the static method for this object
    }

    static clsDate DecreaseDateByXDecades(short Decades, clsDate &Date)
    {
        Date.SetYear(Date.GetYear() - (Decades * 10)); // Correctly decrement the year by decades using the setter
        return Date;
    }
    ...
    {
        // Period of 100 years
        Date.SetYear(Date.GetYear() - 100); // Correctly decrement the year by 100 using the setter
        return Date;
    }

    void DecreaseDateByOneCentury()
    {
        DecreaseDateByOneCentury(*this); // Use the static method for this object
    }

    static clsDate DecreaseDateByOneMillennium(clsDate &Date)
    {
        // Period of 1000 years
        Date.SetYear(Date.GetYear() - 1000); // Correctly decrement the year by 1000 using the setter
        return Date;
    }
    ...
    static short DaysUntilTheEndOfMonth(clsDate Date1)
    {
        ...
        // Set the day, month, and year using setter methods
        EndOfMontDate.SetDay(NumberOfDaysInAMonth(Date1.GetMonth(), Date1.GetYear())); // Set day to the last day of the month
        EndOfMontDate.SetMonth(Date1.GetMonth());                                      // Set the month
        EndOfMontDate.SetYear(Date1.GetYear());                                        // Set the year

        // Calculate the difference in days between the given date and the end of the month
    ...
    static short DaysUntilTheEndOfYear(clsDate Date1)
    {
        ...
        // Set the day, month, and year using setter methods
        EndOfYearDate.SetDay(31);               // Set day to 31
        EndOfYearDate.SetMonth(12);             // Set month to December
        EndOfYearDate.SetYear(Date1.GetYear()); // Set year to the year of Date1

        // Calculate the difference in days between Date1 and the end of the year
